...
| **T-8** | **Ícones cheios nos cards de tratamento** | ⬜ **8 de 18 aplicados.** Os arquivos do acervo do estúdio entraram em `Icones-site/grupo-2/` e substituíram o traço em 3 cards do Jonathas e 5 do Matheus. Vieram do Elementor com uma plaqueta 64×64 em volta, removida no import — o glifo estava vazado nela por `evenodd`, então tirar o retângulo externo inverte a paridade e devolve a forma cheia. No CSS é `.card-ic__ic svg.ic-solido`. **Faltam 10:** 3 do Jonathas (desproporção entre maxilares, assimetria facial, aparelho não resolve), 1 do Matheus (alteração no disco) e os **6 do Lucas** — o modelo era uma LP de ortognática e ATM, nunca teve cirurgia oral. Até lá, as grades do Jonathas e do Matheus mostram os dois estilos juntos |
